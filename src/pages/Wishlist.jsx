  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow">
      <div className="relative">
        ...
        <button className="absolute top-2 right-2 text-gray-500 hover:text-gray-700"onClick={()=>removeFromWishlist(id)} >
      ...
      <button
        ...
        onClick={() => addToCart({ id,image, title, price, discountedPrice, rating, reviews, discount, isNew })}
      >
        Add to Cart
      </button>
    </div>
